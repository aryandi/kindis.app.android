...
public class ApiHelper {
    public static String BASE_URL = "http://api.stg.kindis.co/";
    ...
    public static String TAKLIM = BASE_URL + "home?channel_id=9";
    public static String ITEM_ARTIST = BASE_URL + "artist/items?artist_id=";
    public static String ITEM_ALBUM = BASE_URL + "album/items?album_id=";
    public static String ITEM_SINGLE = BASE_URL + "single/items";
    ...
    public static String PLAYLIST = BASE_URL + "playlist/user";
}
